# -*- coding: utf-8 -*-
"""Driver_Behaviour_Classification.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1IgoCBO9TtzTBaHnylknTZ8Pgd--OCeqn
"""
...
# ✅ Step 3: Function to compute heading angle
...
# ✅ Step 4: Function to compute 3rd order steering entropy
...
# ✅ Step 5: Process each file and compute entropies
all_entropies = []
file_labels = []
vehicle_ids = []
...
# ✅ Compute intersection thresholds
...
# Automatically download the figure
files.download(plot_filename)

# ✅ Print GMM and K-Means Metrics
print("\n✅ GMM Metrics:")
print("Means:", means)
