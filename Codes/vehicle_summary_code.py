# -*- coding: utf-8 -*-
"""Vehicle_Summary_Code.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ZWe7YWyvKsWxZW1zy0_saxrs5yx7pU3u
"""

# ✅ Google Colab Code: Full Vehicle Summary with Radius, Widening, Safety Margins + Encroachment Status + Descriptive Headings
...
# Step 3: Compute Encroachment Status based on sign change of Distance from centreline
...
# Step 4: Group by VehicleID and Compute Metrics
agg_columns = {
...
# Step 6: Rename standard deviation and coefficient of variation columns
...
# Calculate Coefficient of Variation (CV) and rename fully
