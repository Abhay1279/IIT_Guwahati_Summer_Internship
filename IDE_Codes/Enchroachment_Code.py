...
vehicle_path = input("Enter path to Merged/Smoothen vehicle CSV: ").strip()
road_path = input("Enter path to Homography road CSV: ").strip()
...
output_file = os.path.join(downloads, "Encroachment_Episode_With_Behavior.csv")
